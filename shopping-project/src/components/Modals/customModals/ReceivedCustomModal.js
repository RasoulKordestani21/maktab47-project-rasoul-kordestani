...
function ReceivedCustomModal(props) {
  ...
  const body = (
    ...
    >
      ...
      <div>
        ...
        <div>
          <span>آدرس: </span>
          <span>تهران- خ انقلاب-کوچه ی سوم- پلاک ۳</span>
        </div>
        <div>
          <span>تلفن : </span>
          <span>۰۹۱۳۸۸۲۱۹۹۸</span>
        </div>
        <div>
          <span>زمان تحویل : </span>
          <span>۱۴۰۰/۰۳/۱۲</span>
        </div>
        <div>
      ...
      <div style={{ display: "flex" }}>
        <Button style={{ backgroundColor: "purple", margin: "220px auto" }}>
          ذخیره
        </Button>
      </div>

      <div style={{ display: "flex" }}>
        <Button style={{ backgroundColor: "purple", margin: "20px auto" }}>
          ذخیره
        </Button>
      </div>
    </div>
...
const mapStateToProps = (state) => {
  console.log(state.modalFlagReducer.ReceivedCustomModalFlag);
  return {
    state,
  };
};
