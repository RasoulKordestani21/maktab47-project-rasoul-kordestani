    ...
    >
      ...
      <div>
        ...
        <TextField
          ...
          variant="standard"
          onInput={(e) => {
            setModalData({ ...modalData, image: e.target });
      ...
      <div style={{ marginTop: "20px" }}>
        ...
        >
          ...
          <Select
            ...
            onChange={(e) => {
              let baseGroup = findInexOfOptions(e);
              setModalData({
                ...modalData,
                group: e.target.value,
                baseGroup,
                groupToPersian: e.nativeEvent.target.innerText,
              });
            }}
      ...
      <div style={{ display: "flex" }}>
        <Button
          style={{ backgroundColor: "purple", margin: "20px auto" }}
          onClick={() => {
            props.addModalFlag
              ? postProductsData(modalData)
              : editProductWithModal(props.index, filterEditedItems(modalData));
            props.shouldUpdateTable();
            setModalData(initializeObject);
          }}
        >
          ذخیره
        </Button>
  ...
  return (
    <div>
      ...
      <Modal
        open={open}
        onClose={() => {
          props.modalFlagAction(false, false);
        }}
