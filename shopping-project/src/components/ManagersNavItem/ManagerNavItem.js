...
export function ManagerNavItem(props) {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between" }}>
      <div>
        <Button style={managerNav} type="button" onClick={productPage}>
          {" "}
          مدیریت کالاها
        </Button>
        <Button style={managerNav} type="button" onClick={StockPricePage}>
          {" "}
          مدیریت موجودی ها{" "}
        </Button>
        <Button style={managerNav} type="button" onClick={customPage}>
          {" "}
          مدیریت سفارش ها
        </Button>
      </div>
