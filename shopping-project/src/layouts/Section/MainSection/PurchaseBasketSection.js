...
function PurchaseBasketSection(props) {
  ...
  return (
    <div className={styles["main-section-purchase-basket"]}>
      ...
      <TableContainer
        className={styles["main-section-purchase-basket-table"]}
        component={Paper}
      >
            ...
            {props.choosenProduct.choosenProducts.map((ele) => (
              <StyledTableRow>
                ...
                <StyledTableCell
                  ...
                  onClick={() => props.deleteProduct(ele)}
                >
                  {" "}
                  حذف
                </StyledTableCell>
      ...
      <div className={styles["main-section-purchase-basket-bottom-part"]}>
        <div>
          <h5
            className={
              styles["main-section-purchase-basket-bottom-part-whole-price"]
            }
          >
            قیمت کل :{" "}
            {calcWholePrice(
        ...
        <div
          className={
            styles["main-section-purchase-basket-bottom-part-button-parent"]
          }
        >
          <Button
            className={
              styles["main-section-purchase-basket-bottom-part-button"]
            }
            onClick={() => goToFinalizePurchase()}
          >
            نهایی کردن خرید
          </Button>
        </div>
